          ...
          <form className={`pt-1 ${menuState === 'preferences' ? '' : 'd-none'}`}>
            ...
            <div className='pb-4 border-bottom'>
              <label className='form-check form-switch form-switch-sm form-check-custom  flex-stack'>
                ...
                <input className='form-check-input custom-form-check-input' type='checkbox' value='1' defaultChecked />
              </label>
            </div>
            ...
            <div className='py-4 border-bottom'>
              <label className='form-check form-switch form-switch-sm form-check-custom  flex-stack'>
                ...
                <input className='form-check-input custom-form-check-input' type='checkbox' value='1' />
              </label>
            </div>
            ...
            <div className='py-4 border-bottom'>
              <label className='form-check form-switch form-switch-sm form-check-custom  flex-stack'>
                ...
                <input className='form-check-input custom-form-check-input' type='checkbox' />
              </label>
            </div>
